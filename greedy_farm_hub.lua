...
-- FIX: Wrap loading animation vào task.spawn để không block main thread
-- Nguyên nhân đơ menu: các task.wait() dưới đây chạy blocking, chặn
-- toàn bộ code GUI phía sau không được khởi tạo cho đến khi loading xong.
task.spawn(function()
